...
CREATE TABLE IF NOT EXISTS `animal`.`user` (
  ...
  `lastime` INT NOT NULL DEFAULT '' COMMENT '最近一次登录时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `animal`.`comment` (
  ...
  `fromid` INT UNSIGNED NOT NULL DEFAULT '',
  `toid` INT UNSIGNED NOT NULL DEFAULT '',
  PRIMARY KEY (`id`))
ENGINE = Myisam;
...
CREATE TABLE IF NOT EXISTS `animal`.`article` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `content` TEXT NOT NULL DEFAULT '' COMMENT '发布文章内容',
  `title` VARCHAR(45) NOT NULL DEFAULT '' COMMENT '发布文章主题',
  `pubtime` INT NOT NULL DEFAULT '' COMMENT '发布文章时间',
  `click_count` INT NOT NULL DEFAULT 0 COMMENT '用户浏览量',
  `uid` INT UNSIGNED NOT NULL DEFAULT '' COMMENT '发表文章那个人的id',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `animal`.`zan` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `aid` INT UNSIGNED NOT NULL DEFAULT '' COMMENT '被点赞的文章的id',
  `uid` INT NOT NULL DEFAULT '' COMMENT '用户点赞的id',
...
CREATE TABLE IF NOT EXISTS `animal`.`pic` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `uid` INT NOT NULL DEFAULT '' COMMENT '用户id',
