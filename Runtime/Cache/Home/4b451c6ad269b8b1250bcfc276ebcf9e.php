...
<div class="container">
            <div class="row row-centered">
                <div class="well col-md-6 col-centered">
                    <h3 style="text-align:center">农牧大家评-登录</h3>
                    <form action="<?php echo U('User/login');?>" method="post" role="form">
...
<img id = "verifyImg"  style="margin-left:5px" width="80px" height="33px" src="<?php echo U('Home/User/verify');?>" 
                         ...
                         <div id = "errVer"></div>
                        <br/>
                        <button type="submit" id="submits" class="btn btn-success btn-block">登录</button>
                    </form>
                </div>
            </div>
        </div>
